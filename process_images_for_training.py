...
aspect_ratio = 1.3 # 1.3 is the most frequent height/width aspect ratio in the entire MURA dataset (~30% of all images; 1.2 & 1.4 were also each ~10% of images)
new_height = 30
...
dir_out = "/notebooks/scratch-folder/MURA-Dataset-Processed/resized-30-23/" # ENSURE CORRECT
